...
/**
 * WhmcsProduct filter form base class.
 *
 * @package    shop
 * @subpackage filter
 * @author     Dmitriy
 ...
 */
abstract class BaseWhmcsProductFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('whmcs_product_filters[%s]');
