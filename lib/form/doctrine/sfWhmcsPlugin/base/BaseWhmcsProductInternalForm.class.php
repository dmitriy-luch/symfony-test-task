...
/**
 * WhmcsProductInternal form base class.
 *
 * @method WhmcsProductInternal getObject() Returns the current form's model object
 *
 * @package    shop
 * @subpackage form
 * @author     Dmitriy
 ...
 */
abstract class BaseWhmcsProductInternalForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'gid'                    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ShopGroup'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'gid'                    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ShopGroup'))),
    ...
    $this->widgetSchema->setNameFormat('whmcs_product_internal[%s]');
